                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                <div class="inner">
                                    <h3><?= is_array($cuti) && isset($cuti['total_cuti']) ? $cuti['total_cuti'] : 0 ?></h3>
                                    <p>Data Cuti</p>
                                </div>
                                <div class="icon">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-success">
                                <div class="inner">
                                    <h3><?= is_array($cuti_acc) && isset($cuti_acc['total_cuti']) ? $cuti_acc['total_cuti'] : 0 ?></h3>
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-danger">
                                <div class="inner">
                                    <h3><?= is_array($cuti_reject) && isset($cuti_reject['total_cuti']) ? $cuti_reject['total_cuti'] : 0 ?></h3>
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    <h3><?= is_array($cuti_confirm) && isset($cuti_confirm['total_cuti']) ? $cuti_confirm['total_cuti'] : 0 ?></h3>
                            ...
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    <h3>
                                        ...
                                        $total_cuti_tahunan = 12; // Total cuti tahunan yang diizinkan
                                        $cuti_digunakan = isset($cuti_pegawai) ? count($cuti_pegawai) : 0; // Menghitung cuti yang telah digunakan
                                        
                                        if (is_array($cuti_pegawai) && isset($cuti_pegawai[0]['berakhir']) && $cuti_pegawai[0]['berakhir'] !== null) {
                                            $now = time();
                                            ...
                                            if ($date_akhir >= 0) {
                                                ...
                                                echo "Cuti Sudah Berakhir";
                                            }
                                        } else {
                                            $sisa_cuti = $total_cuti_tahunan - $cuti_digunakan;
                                            echo $sisa_cuti > 0 ? $sisa_cuti . ' Hari Tersisa' : 'Cuti Habis';
                                        }
                                        ?>
                                    </h3>
                                    <p>Sisa Cuti</p>
